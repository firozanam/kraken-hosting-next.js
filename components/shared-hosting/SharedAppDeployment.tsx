...
export const SharedAppDeployment = () => {
    const t = useTranslations("AppDeployment");
                ...
                >
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                        {applications.map((app, index) => (
                            ...
                            >
                                <div
                                    className="rounded-xl p-4 lg:p-5 flex items-center gap-4 cursor-pointer bg-[#13191d] border border-[#7424e1] transition-all duration-300 hover:scale-105 hover:-translate-y-1 h-full"
                                >
