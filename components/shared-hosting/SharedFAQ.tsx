...
export const SharedFAQ = ({ title, questions }: SharedFAQProps) => {
                    ...
                    <div className="max-w-4xl mx-auto space-y-4">
                        {questions.map((faq: FAQItem, index: number) => (
                            ...
                            >
                                ...
                                >
                                    <p className="text-gray-400 text-sm lg:text-base leading-relaxed pl-0 pr-8" dangerouslySetInnerHTML={{ __html: faq.answer }} />
                                </div>
                            </FadeIn>
                        ))}
                    </div>
