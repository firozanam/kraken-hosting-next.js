...
export const SharedVisionSection = () => {
    const t = useTranslations("SharedVisionSection");
    ...
    return (
        <section className="relative w-full bg-[#13191d] py-20 lg:py-32">
            <div className="w-full content-padding-x mx-auto container-ultrawide relative z-10">
                ...
                {/* Header Text */}
                <FadeIn className="text-center mb-16 lg:mb-24 max-w-5xl mx-auto space-y-6">
                ...
                {/* Light Green CTA Box removed as per user request */}
