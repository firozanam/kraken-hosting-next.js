...
export const Hero = () => {
    const t = useTranslations("HostingHero");
        ...
        <section className="relative min-h-[100dvh] h-auto w-full text-white flex flex-col bg-[#13191d] overflow-x-hidden">
            ...
            <div className="w-full content-padding-x mx-auto container-ultrawide relative z-10 flex flex-col lg:flex-row lg:items-center justify-between pt-32 md:pt-40 pb-12 lg:pt-0 lg:pb-0 gap-12">
                ...
                <FadeIn
                    direction="right"
                    duration={600}
                    className="w-full lg:w-1/2 flex flex-col justify-center space-y-2 lg:space-y-2 xl:space-y-3 lg:pt-12 xl:pt-16 2xl:pt-20"
                >
                    <FadeIn
                        direction="up"
                        delay={200}
                    ...
                    >
                        ...
                        <div className="flex items-baseline gap-2 mb-6">
                            <span className="font-bold bg-gradient-to-r from-[#89d957] to-[#c9e265] bg-clip-text text-transparent text-3xl lg:text-4xl xl:text-5xl">{t("price")}</span>
                            <span className="text-sm lg:text-base xl:text-lg text-white">{t("period")}</span>
                        </div>
                ...
                <div className="hidden lg:flex w-full lg:w-1/2 relative items-center justify-center lg:justify-end mt-8 lg:mt-0 lg:pl-10">
                    <div className="relative w-full h-[600px] lg:h-[700px] xl:h-[800px] flex items-center justify-center scale-125 lg:scale-[1.4] xl:scale-[1.5] -mt-24 lg:-mt-48 xl:-mt-56 translate-x-10 lg:translate-x-0 will-change-transform">
                        <div className="relative w-full h-full z-10">
                            <Image
                                src="/images/shared-hosting/shared-hosting.svg"
                                alt="Shared Hosting"
                                fill
            ...
            >
                <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <p className="font-medium bg-gradient-to-r from-[#89d957] to-[#c9e265] bg-clip-text text-transparent text-base md:text-lg lg:text-base xl:text-lg">{t("bottom_features.bandwidth")}</p>
                </div>
                <div className="flex flex-col items-center text-center gap-4">
                    <div className="flex items-center justify-center relative">
                        <Image
                ...
                <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <p className="font-medium bg-gradient-to-r from-[#89d957] to-[#c9e265] bg-clip-text text-transparent text-base md:text-lg lg:text-base xl:text-lg">{t("bottom_features.managed")}</p>
                </div>
            </FadeIn>
        </section>
    );
