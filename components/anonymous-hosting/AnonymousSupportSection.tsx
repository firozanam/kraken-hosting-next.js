...
export const SupportSection = () => {
    const t = useTranslations("AnonymousPricing.Support");
            ...
            <div className="w-[90%] lg:w-[85%] mx-auto container-ultrawide relative z-10 border border-[#7c37eb] rounded-3xl p-8 lg:p-12 overflow-hidden bg-[#13191d]/50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 relative">
                    ...
                    <div className="flex flex-col relative z-20 lg:pr-12">
                        ...
                        >
                            <h3 className="text-xl lg:text-2xl font-bold text-white mb-2">
                                <span dangerouslySetInnerHTML={{ __html: t.raw("migration_title") }} />
                            </h3>
                    ...
                    <div className="flex flex-col justify-end items-center lg:items-end relative mt-8 lg:mt-0">
                        ...
                        {/* Mobile: Negative top margin pulls it up over the container padding/migration text spacing slightly to minimize gaps */}
                        <FadeIn
                            direction="left"
                            duration={800}
                            className="relative w-[calc(100%+4rem)] -mx-8 lg:w-[130%] lg:mx-0 h-[500px] lg:h-[600px] lg:absolute lg:bottom-16 lg:right-0 lg:-mr-20 pointer-events-none -mt-12 lg:mt-0 z-10 transition-all"
                        >
                            <Image
                                src="/images/privacy-shared-hosting/support.svg"
                                alt="Support Team"
                                fill
