...
export const Features = () => {
    const t = useTranslations("AnonymousPricing.Features");
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <FadeIn
                            delay={0}
                            direction="up"
                            className="bg-white rounded-3xl flex flex-col items-center text-center overflow-hidden min-h-auto lg:min-h-[350px] transition-transform duration-300 hover:-translate-y-1"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <FadeIn
                            delay={400}
                            direction="up"
                            className="bg-white rounded-3xl p-8 flex flex-col items-center text-center overflow-hidden transition-transform duration-300 hover:-translate-y-1"
                        >
