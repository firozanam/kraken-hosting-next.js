...
export const Benefits = () => {
    const t = useTranslations("KrakenSecureWebBenefits");
    ...
    return (
        <section className="relative w-full text-white bg-[#13191d] overflow-hidden">
            ...
            <div className="relative py-20 lg:py-32">
                ...
                {/* Content */}
                <div className="container-ultrawide relative z-20 w-full content-padding-x max-w-4xl mx-auto space-y-16 lg:space-y-24 text-center mt-24 lg:mt-[500px]">

                    {/* Block 1: Trust and Credibility */}
                    <FadeIn className="space-y-4">
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">
                            {t("blocks.trust_credibility.title")}
                        </h3>
                        <p className="text-gray-300 text-sm lg:text-base leading-relaxed max-w-3xl mx-auto">
                            {t("blocks.trust_credibility.description")}
                        </p>
                    </FadeIn>

                    {/* Block 2: Proactive Threat Mitigation */}
                    <FadeIn delay={200} className="space-y-4">
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">
                            {t("blocks.threat_mitigation.title")}
                        </h3>
                        <p className="text-gray-300 text-sm lg:text-base leading-relaxed max-w-3xl mx-auto">
                            {t("blocks.threat_mitigation.description")}
                        </p>
                    </FadeIn>

                    {/* Block 3: Ironclad Data Integrity */}
                    <FadeIn delay={400} className="space-y-4">
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">
                            {t("blocks.data_integrity.title")}
                        </h3>
                        <p className="text-gray-300 text-sm lg:text-base leading-relaxed max-w-3xl mx-auto">
                            {t("blocks.data_integrity.description")}
                        </p>
                    </FadeIn>

                    {/* Block 4: Operational Sovereignty */}
                    <FadeIn delay={600} className="space-y-4">
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">
                            {t("blocks.sovereignty.title")}
                        </h3>
                        <p className="text-gray-300 text-sm lg:text-base leading-relaxed max-w-3xl mx-auto">
                            {t("blocks.sovereignty.description")}
                        </p>
                    </FadeIn>

                    {/* Block 5: Maximum Performance & Trust */}
                    <FadeIn delay={800} className="space-y-4">
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">
                            {t("blocks.performance_trust.title")}
                        </h3>
                        <p className="text-gray-300 text-sm lg:text-base leading-relaxed max-w-3xl mx-auto">
                            {t("blocks.performance_trust.description")}
                        </p>
                    </FadeIn>
